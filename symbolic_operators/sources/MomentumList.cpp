...
MomentumList::MomentumList(const Momentum& momentum) : momenta{momentum} {}

MomentumList::MomentumList(const Momentum& first, const Momentum& second) : momenta{first, second} {}

MomentumList::MomentumList(std::initializer_list<Momentum> init) : momenta(init) {}

MomentumList::MomentumList(std::initializer_list<char> init) : momenta{std::vector<Momentum>(init.size())} {
