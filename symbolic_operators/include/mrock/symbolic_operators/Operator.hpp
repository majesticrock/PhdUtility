#ifndef MROCK_SYMBOLIC_OPERATORS_INCLUDE_MROCK_SYMBOLIC_OPERATORS_OPERATOR_HPP
#define MROCK_SYMBOLIC_OPERATORS_INCLUDE_MROCK_SYMBOLIC_OPERATORS_OPERATOR_HPP
/**
 * @file Operator.hpp
...
struct Operator {
    ...
    bool is_fermion{
        true};  ///< Indicates if the operator is a fermion. This of course impacts the commutation relation [O',
                ///< O^+]_{+/-} = delta_{O,O'}, where the plus applies to fermions and the minus to bosons.
    ...
    /**
     * @brief Constructs an Operator with specified momentum symbol name, sign, addition flag, indices, daggered state,
     * and fermion state.
     * @param _momentum The name of the momentum symbol.
...
#endif  // MROCK_SYMBOLIC_OPERATORS_INCLUDE_MROCK_SYMBOLIC_OPERATORS_OPERATOR_HPP
