 ...
 *
 * Macros:
 * - \c MROCK_VECTOR_WRAPPER_FILL_MEMBERS(_T,_vector_name): Defines type aliases and common member functions for a \c
 * std::vector<_T>.
 *
 * Example usage:
 * @code
...
#define MROCK_VECTOR_WRAPPER_FILL_MEMBERS(_T, _vector_name)                         \
    using value_type = typename std::vector<_T>::value_type;                        \
