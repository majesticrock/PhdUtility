 ...
 */
template <class T>
constexpr bool defines_plus_v() {
    return defines_plus<T>::value;
};
 ...
 */
template <class T>
constexpr bool defines_minus_v() {
    return defines_minus<T>::value;
};
 ...
 */
template <class T>
constexpr bool defines_product_v() {
    return defines_product<T>::value;
};
 ...
 */
template <class T>
constexpr bool defines_division_v() {
    return defines_division<T>::value;
};
 ...
 */
template <class T>
constexpr bool is_linearly_combinable_v() {
    return is_linearly_combinable<T>::value;
};
