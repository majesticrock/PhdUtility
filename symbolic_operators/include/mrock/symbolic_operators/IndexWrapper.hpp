...
inline const std::map<std::string, Index> string_to_index = {
    {"up", Index::SpinUp},         {"down", Index::SpinDown},   {"sigma", Index::Sigma},
    {"sigma'", Index::SigmaPrime}, {"S", Index::GeneralSpin_S}, {"S'", Index::GeneralSpin_SPrime},
    {"A", Index::TypeA},           {"B", Index::TypeB},         {"C", Index::TypeC},
    {"a", Index::char_a},          {"b", char_to_index('b')},   {"c", char_to_index('c')},
    {"d", char_to_index('d')},     {"e", char_to_index('e')},   {"f", char_to_index('f')},
    {"g", char_to_index('g')},     {"h", char_to_index('h')},   {"i", char_to_index('i')},
    {"j", char_to_index('j')},     {"k", char_to_index('k')},   {"l", char_to_index('l')},
    {"m", char_to_index('m')},     {"n", char_to_index('n')},   {"o", char_to_index('o')},
    {"p", char_to_index('p')},     {"q", char_to_index('q')},   {"r", char_to_index('r')},
    {"s", char_to_index('s')},     {"t", char_to_index('t')},   {"u", char_to_index('u')},
    {"v", char_to_index('v')},     {"w", char_to_index('w')},   {"x", char_to_index('x')},
    {"y", char_to_index('y')},     {"z", char_to_index('z')}};
