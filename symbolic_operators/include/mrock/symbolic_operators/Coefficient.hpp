...
/**
 * @struct Coefficient
 * @brief Represents a coefficient. Various symmetries are predefined (e.g. inversion symmetry) and can be toggled on or
 * off A custom symmetry can also be provided
 */
struct Coefficient {
     ...
     */
    static Coefficient RealInversionSymmetric(
     ...
     * 		The Current implementation is restricted to a MomentumList of size 1, i.e., V(k) or V(k-l) but not V(k,
     * l)
