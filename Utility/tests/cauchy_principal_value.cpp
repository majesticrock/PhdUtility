...
using base_integrator = Utility::Numerics::Integration::CauchyPrincipalValue<Real, 60>;
using gen_integrator = Utility::Numerics::Integration::GeneralizedPrincipalValue<Real, 60>;
...
int main() {
    ...
    std::cout << "\n###############################\n" << std::endl;
    {
        ...
        result_set_A numerical_results = { 
            ...
            Utility::Numerics::Integration::GeneralizedPrincipalValue<Real, 10000>::generalized_principal_value(f4, a, b, std::vector<Real>{ 0.5 * (c - 1), 0.5 * (c + 1) })
        };
        result_set_A analytical_results = { 
            ana1(a, b, c),
            ana2(a, b, c, d),
