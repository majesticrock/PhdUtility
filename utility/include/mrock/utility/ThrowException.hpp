 ...
 * @param condition If true the exception is thrown. May be used with the macro \c MROCK_NDEBUG_CONDITION(condition)
 * which is only evaluated if \c NDEBUG is not defined.
