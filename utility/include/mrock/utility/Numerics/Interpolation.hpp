...
constexpr y_type linearly_interpolate(x_type const& x,
                                      x_type const& x0,
                                      x_type const& x1,
                                      y_type const& y0,
                                      y_type const& y1) {
...
constexpr y_type interpolate_lagrange(x_type const& x,
                                      std::array<x_type, n> const& x_data,
                                      std::array<y_type, n> const& y_data) {
...
inline __detail::element_t<y_vector> interpolate_from_vector(__detail::element_t<x_vector> const& x,
                                                             x_vector const& x_data,
                                                             y_vector const& y_data,
                                                             unsigned int start_index_x,
                                                             int index_offset_y = 0) {
