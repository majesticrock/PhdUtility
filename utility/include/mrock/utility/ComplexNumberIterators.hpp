...
public:
    ...
    T operator[](difference_type n) const { return (ptr + n)->real(); }

    RealPartIterator& operator++() {
        ++ptr;
        return *this;
    }
    RealPartIterator operator++(int) {
        RealPartIterator tmp = *this;
        ++(*this);
        return tmp;
    }
    RealPartIterator& operator--() {
    ...
    RealPartIterator& operator+=(difference_type n) {
        ptr += n;
        return *this;
    }
    RealPartIterator operator-(difference_type n) const { return RealPartIterator(ptr - n); }
...
public:
    ...
    T operator[](difference_type n) const { return (ptr + n)->imag(); }

    ImagPartIterator& operator++() {
        ++ptr;
        return *this;
    }
    ImagPartIterator operator++(int) {
        ImagPartIterator tmp = *this;
        ++(*this);
        return tmp;
    }
    ImagPartIterator& operator--() {
    ...
    ImagPartIterator& operator+=(difference_type n) {
        ptr += n;
        return *this;
    }
    ImagPartIterator operator-(difference_type n) const { return ImagPartIterator(ptr - n); }
