...
int main() {
...

    {
        ...
        constexpr bool complex_float_is_float = std::is_same_v<UnderlyingRealType_t<std::complex<float>>, float>;

        constexpr bool complex_double_is_double = std::is_same_v<UnderlyingRealType_t<std::complex<double>>, double>;
...

    {
        ...
        constexpr bool const_double_is_double = std::is_same_v<UnderlyingRealType_t<const double>, double>;

        constexpr bool double_ref_is_double = std::is_same_v<UnderlyingRealType_t<double&>, double>;

        constexpr bool const_double_ref_is_double = std::is_same_v<UnderlyingRealType_t<const double&>, double>;

        constexpr bool volatile_float_ref_is_float = std::is_same_v<UnderlyingRealType_t<volatile float&>, float>;
...

    {
        ...
        constexpr bool complex_double_ref_is_double = std::is_same_v<UnderlyingRealType_t<ComplexDouble&>, double>;
...

    {
        ...
        constexpr bool struct_plain = std::is_same_v<typename UnderlyingRealType<int>::type, int>;

        constexpr bool struct_complex = std::is_same_v<typename UnderlyingRealType<std::complex<double>>::type, double>;
